...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00D80DB6u);
	CY_SET_REG32((void *)(CYREG_PRT0_PC2), 0x00000030u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x00DB6DB6u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x0000000Bu);
	...
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x00DB6DA4u);

	/* IOPINS0_4 Starting address: CYDEV_PRT4_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT4_BASE), 0x0000000Au);
	CY_SET_REG32((void *)(CYREG_PRT4_PC), 0x00000006u);
	CY_SET_REG32((void *)(CYREG_PRT4_PC2), 0x0000000Eu);
